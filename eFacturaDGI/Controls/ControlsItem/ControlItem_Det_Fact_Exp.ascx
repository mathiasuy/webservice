<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControlItem_Det_Fact_Exp.ascx.cs" Inherits="eFacturaDGI.Controls.ControlsItem.ControlItem_Det_Fact_Exp" %>
...
<Columns>
    <asp:TemplateField  HeaderText="Retenciones Percepciones">
           <EditItemTemplate> 
                <asp:Button ID="btnRet" runat="server" Text="Ver..."  ></asp:Button> 
           </EditItemTemplate> 
           ...
           <ItemTemplate> 
                <asp:Button ID="btnRet" runat="server" Text="Ver..." onClick="ClickbtnRet" ></asp:Button> 
           </ItemTemplate>
    </asp:TemplateField>
</Columns>
<Columns>
    <asp:TemplateField  HeaderText="Monto">
           <ItemTemplate> 
            <asp:Label ID="lblMonto" runat="server" Text='<%# Bind("MontoItem") %>'></asp:Label> 
           </ItemTemplate>
        <FooterTemplate> 
