...
{
    public class Receptor_Fact_Exp :Receptor
    {
        public Receptor_Fact_Exp(NumeroDocumento Documento, PaisType Pais, string RznSocRecep, string DirRecep, string CiudadRecep,
